...
namespace PerceptronLocalService.Engine
{
    public class PstGeneratorCpu : IPeptideSequenceTagGenerator
    {
        ...
        //private List<PstTagList> PstTagInfoList(List<List<PstTagsDto>> LadderList, SearchParametersDto parameters)
        //{
        //    string psttags;
        //    int psttaglength;
        ...
        //            pstintensity = pstintensity + LadderList[indexouterLadderList][indexinnerLadderList].averageIntensity;  //averageIntensity= mean intensity of 2 peaks
        //        }
        ...
        //        var UniquePstTagMinError = (from c in psttaginfolist group c by c.psttags into g where g.Key == uniquepsttag
        ...
        //private List<List<PstTagsDto>> TrimPstTags(List<List<PstTagsDto>> multipleLenghtTagList, SearchParametersDto parameters)
        //{
        ...
        //public List<List<int>> GetConsecutiveNumberCombination(int numberofelements)
        //{
        ...
        //private List<PstTagList> AccomodateIsoforms(List<PstTagList> FinalPstTagList, SearchParametersDto parameters)
        //{
